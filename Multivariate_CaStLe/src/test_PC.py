"""
Script for testing PC on 2D SCM(VAR) data.

This script evaluates the performance of the PC algorithm on 2-dimensional
Structural Causal Model (SCM) data with Vector Autoregression (VAR). It loads spatial coefficients and data,
computes the true graph based on the dataset's coefficients, applies the PC algorithm to reconstruct
...
SAVE_PATH_DIR = SAVE_PATH_DIR[:-5] + "/results_pc/"
