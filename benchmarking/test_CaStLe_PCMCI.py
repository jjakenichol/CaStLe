"""
Script for testing CaStLe-PCMCI on 2D SCM(VAR) data.
...
4. Fits the CaStLe-PCMCI model to the data.
...
Example usage:
python benchmarking/test_CaStLe_PCMCI.py --data_path path/to/data.npy --print --verbose
"""
