"""
Script for testing multivariate CaStLe-PC on 2D SCM(VAR) data.

This script evaluates the performance of the multivariate CaStLe-PC algorithm on 2-dimensional
...
SAVE_PATH_DIR = SAVE_PATH_DIR[:-5] + "/results_castle_pc/"
